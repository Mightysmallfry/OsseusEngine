#include "Scenarios/OrbitCubeScenario.h"
...
namespace sandbox {
    ...
    void OrbitCubeScenario::Initialize(osseus::PhysicsWorld& world, double width, double height) {
        ...
        const double minimumDistance = staticRadius_ + halfExtent_;
    ...
    void OrbitCubeScenario::Update(osseus::PhysicsWorld& world) {
