...
namespace osseus {
    ...
    void IntegratorRungeKutta4::Step(BodyManager& bodyManager, ForceManager& forceManager, double delta) {
        ...
        barnesHut_.Evaluate(state2.GetOctree(), state2.GetHandles(), state2.GetBodies(), forceMan);
        ...
        barnesHut_.Evaluate(state3.GetOctree(), state3.GetHandles(), state3.GetBodies(), forceMan);
        ...
        barnesHut_.Evaluate(state4.GetOctree(), state4.GetHandles(), state4.GetBodies(), forceMan);
